...
import org.usfirst.frc.team5298.robot.commands.LiftSwitch;
import org.usfirst.frc.team5298.robot.commands.LiftScale;
import org.usfirst.frc.team5298.robot.commands.LiftTop;
*/
...
public class OI {
	...
	public OI() {
    	...
    	//driverPad.getBottomButton().whenPressed(new Reorient());
		//operatorPad.getDPadDown().whenPressed(new LiftBottom());
