...
public class Transciever extends Subsystem{
	...
	public Thread transmitter, receiver;
	...
	static class Transmitter implements Runnable {
	    ...
	    String info = "No data being transmitted";
	...
	public Transciever() {
		...
		// Starting threads.
		Transmitter tx = new Transmitter(outboundQueue);
		transmitter = new Thread(tx);
		transmitter.start();
		
		Receiver rc = new Receiver(inboundQueues);
		receiver = new Thread(rc);
		receiver.start();
